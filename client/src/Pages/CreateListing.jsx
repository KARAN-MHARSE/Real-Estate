...
function CreateListing() {
  ...
  const handleSubmit = async (e) => {
    ...
    // formDataObj.append("userRef", currentUser._id);
    formDataObj.append("agent", currentUser._id);

    // Call api
    const res = await fetch("http://localhost:5000/api/v1/listing/create", {
      method: "POST",
      body: formDataObj,
    });
      ...
      <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-4">
        ...
        <div className="flex flex-col flex-1 ">
          ...
          <div className="flex my-5 gap-3">
            ...
            />
            <button className="p-3 bg-white-500 border border-green-700 text-green-700 font-semibold hover:shadow-lg rounded-lg">
              UPLOAD
            </button>
          </div>
